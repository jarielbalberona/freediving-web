...
const navigation = [
  ...
  { name: "Sign In", href: "/sign-in", icon: UserIcon, current: false },
];
  ...
  return (
    <>
      ...
      <div className="lg:pl-72">
        <div className="sticky top-0 z-40 flex items-center h-16 px-4 bg-white lg:bg-transparent shrink-0 gap-x-4 sm:gap-x-6 sm:px-6 lg:px-8">
          <button
            type="button"
